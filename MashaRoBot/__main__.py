...
START_IMAGE=(https://telegra.ph/file/0813c2a8fc91296d963bc.jpg)
...
You can support the project via [Paypal](https://www.paypal.me/ShrayanshSharma27) or by contacting @ShrayanshSharma \
 ...
 Those who cannot provide monetary support are welcome to help us develop the bot at [Winnie Support](https://t.me//WinnieXSupport)."""
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" Hoi I'm *Winnie*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n_Winnie's licensed under the GNU General Public License v3.0_
